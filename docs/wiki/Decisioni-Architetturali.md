...
| [ADR-0011](https://github.com/Aiacos/EvenFoundryVTT/blob/develop/docs/architecture/0011-foundry-write-path-single-workflow-origin.md) | Write path con origine unica: ogni mutazione passa da `dispatchTool`; solo `src/write-path/` chiama `activity.use()` (gate CI 8) | accettato (emendato da 0017: l'origine è il projector eletto) |
...
| [ADR-0003](https://github.com/Aiacos/EvenFoundryVTT/blob/develop/docs/architecture/0003-tool-registry-pattern.md) | Registro dei tool condiviso tra gesti MVP e futuri client | accettato (emendato da 0016) |
...
| [ADR-0002](https://github.com/Aiacos/EvenFoundryVTT/blob/develop/docs/architecture/0002-protocol-versioning.md) | Busta WS del bridge, versioni, idempotenza, replay | superato da 0016 |
