...
> **SUPERSEDED IN PART** — 2026-09-25 by [ADR-0019](./0019-relay-pairing-player-projector.md): §1 hosting on Foundry (Foundry ≥ 14.361 serves module HTML as `text/plain`), §2 "(G2)" identity, §3 pairing, §4 transport over the Foundry socket and §6 phone-fetched scene art. The sealed envelope and the projector role stay.
