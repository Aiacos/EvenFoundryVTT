...
> **SUPERSEDED** — 2026-09-25 by [ADR-0019](./0019-relay-pairing-player-projector.md): the phone no longer logs into Foundry, so the "(G2)" users, GM enablement, sealed passwords, ECDH custody and the projector election are removed; whoever shows the QR projects that device. Kept as history.
