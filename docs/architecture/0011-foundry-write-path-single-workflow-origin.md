...
> **AMENDED by [ADR-0013](./0013-player-owned-glasses-hybrid-projector.md)** — 2026-09-23. The single workflow origin is the *elected projector client* for each device (the player's own client when online, else the active GM), still through `dispatchTool`; socketlib is no longer used.
