...
> **AMENDED by [ADR-0012](./0012-direct-foundry-streaming.md)** — 2026-09-23. The registry now lives only in the Foundry module and is invoked by the projector; the bridge REST surface and the MCP consumer were removed.
