...
Last activity: 2026-06-04 -- Completed quick task 260604-ovn: production launch glue (index.html→bootEngine). Engine now boots from launch; revealed engine WS-URL derivation bug (no ws scheme/`/ws` path) as next fix.
