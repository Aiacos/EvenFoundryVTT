...
Last activity: 2026-06-04 -- Completed quick task 260604-lg4: socketlib API misuse fix (real registerModule/register; ready-hook no longer aborts push readers) — the real blocker for Forge pairing
