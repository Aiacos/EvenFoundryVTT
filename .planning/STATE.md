...
| 2026-09-23 | `fast-claude-md-constitution` | `afb9a89` | CLAUDE.md Engineering Constitution P1–P11 (quality, testing, UX, perf, auto-debug, SDK research, docs, hygiene, CI/CD, subagents) + canonical chapter-icon map. gsd-fast. |
| 2026-09-23 | `v0.10.0-direct-streaming` | `f0d900a` | ADR-0012 direct Foundry→G2 streaming (bridge/foundry-mcp/Docker removed, ~85k LOC deleted), one-scan QR pairing (+ Players context menu), D&D-sheet HUD (UX round 2, pixel renderer), demo + sim-check loop (12/12 on evenhub-simulator 0.9.5), 1030 tests / 96% coverage. Branch `feature/direct-streaming-v2`, not pushed. |
