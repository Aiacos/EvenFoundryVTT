...
Last activity: 2026-06-04 -- Completed quick task 260604-pai: engine WS-URL fix + no-auth handshake sentinel. Engine now connects WS + passes handshake; glasses HUD render still blank (container_id/panel lazy-load) → next: /gsd-debug on-glasses render.
