...
Last activity: 2026-06-04 -- Completed quick task 260604-mjr: dedicated Bridge Configuration dialog (settings persist+display via explicit Save). Real Forge pairing verified end-to-end (real PCs in simulator).
