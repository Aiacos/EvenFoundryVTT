...
| C · Map | 144 × 144, top-right | the scene's **original art** (background, tiles, token art) pixelated and dithered to 16 greens, darkness outside your token's sight, vector markers on top; centred on your token, ≤ 1 fps |
